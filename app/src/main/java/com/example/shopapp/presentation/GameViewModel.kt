...
import com.example.shopapp.data.GameRepositoryImpl
...
import com.example.shopapp.domain.usecases.GenerateQuestionUseCase
import com.example.shopapp.domain.usecases.GetGameSettingsUseCase
...
class GameViewModel(
    ...
    private val _foramttedTime = MutableLiveData<String>()
    val formattedTime: LiveData<String> get() = _foramttedTime
    ...
    private fun startTimer() {
        timer = object : CountDownTimer(
            ...
            override fun onTick(millisUntilFinished: Long) {
                _foramttedTime.value = formatTime(millisUntilFinished)
            }
